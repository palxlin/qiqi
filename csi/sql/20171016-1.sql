...
CREATE TABLE `tbl_current_game_detail` (
  ...
  `witness_chosen_cause_of_death_weight` int(10) DEFAULT '0' COMMENT '重要性',
  ...
  `witness_chosen_location_of_crime_weight` int(10) DEFAULT '0' COMMENT '重要性',
...
CREATE TABLE `tbl_current_player` (
  ...
  `detect_crime_pos` int(10) DEFAULT NULL,
  `detect_crime_item_pos` int(10) DEFAULT NULL,
  `detect_crime_clue_pos` int(10) DEFAULT NULL,
...
/*!50001 CREATE VIEW `v_game` AS SELECT 
 ...
 1 AS `witnessCauseOfDeathWeight`,
 1 AS `witnessLocationOfCrimeWeight`,
 1 AS `witnessClue1Weight`,
 1 AS `witnessClue2Weight`,
 1 AS `witnessClue3Weight`,
 1 AS `witnessClue4Weight`,
 1 AS `witnessWeight`*/;
...
-- Dump completed on 2017-10-16 16:42:29
